...
{
    public class SettingsDisplayFrameRate : SettingsBase, ISettingsBase<int>, ISettingsSliderConfiguration
    {
        [Info]
        [SerializeField]
        private string _info =
            "SettingsDisplayFrameRate is responsible for managing the frame rate limit for the display. " +
        ...
        protected override string Reference => "DisplayFramerate";
